...
\newcommand*{\blankpage}{
{\newpage \vspace*{5cm}\thispagestyle{empty}\centering \bfseries  \textit{Esta página se ha dejado en blanco intencionalmente.} \par}
\vspace{\fill}}
...
\def\printauthor{%                  
    {\large \@author}}              
\makeatother
\author{Eduardo Rdgz-Ávila\\
    \texttt{phys.eduardo.ra@gmail.com}
    }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Nombres de la semana para el calendario
%https://tex.stackexchange.com/questions/10186/weekday-captions-with-the-tikz-library-calendar/10199#10199
\makeatletter%
...
\tikzstyle{day letter headings}=[
    execute before day scope={ \ifdate{day of month=1}{%
      ...
      \foreach \d/\l in {0/\tiny{L},1/\tiny{M},2/\tiny{X},3/\tiny{J},4/\tiny{V},5/\tiny{S},6/\tiny{D}} {
        \pgf@xa=\d\pgf@xa%
